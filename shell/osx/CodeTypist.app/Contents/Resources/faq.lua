...
qa_lyr:Insert(_q{
  q = "Where did you get the code snippets from ?",
  a = "From GitHub "
})

qa_lyr:Insert(_q{
  q = "Did you automate the scraping of code snippets ?",
  a = "No. All the code snippets were manually grabbed." ..
      "\nNot everything in this world has to be automated."
})

qa_lyr:Insert(_q{
  q = "Who's the developer ?",
  a = "Brought to you with love by Hemanta Sapkota." ..
      "\nFollow me on:" ..
      "\n Twitter: @laex_pearl" ..
